...
- Blazor front-end (same technology as Competitor A)
...
4. The app requires authentication

---

## Feature Comparison Matrix

| Feature | This Calculator | Competitor A | Competitor B |
|---------|----------------|--------------|--------------|
...
1. **Latest code** - ASCE 7-22/IBC 2024 vs Competitor B's outdated ASCE 7-10
...
1. **PDF reports** - the #1 feature customers pay Competitor A for
...
5. **Construction drawings** - Competitor A generates these
6. **Materials lists** - Competitor A generates these
