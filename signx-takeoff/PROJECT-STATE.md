...
Last updated: 2026-02-26 (overnight task — baseline refresh + CLAUDE.md)

## Status Line
**ACTIVE — 70/70 regression pass, 11/11 validation pass, 30+ API endpoints functional**
...
### Medium Priority
- [ ] **G: drive bash access** — MSYS path translation blocks `ls G:/...` from bash.
  Mitigation: use Python pathlib. Do not use bash `ls` for G: drive paths.
- [ ] **POLNON** — non-illuminated pylon not yet in engine (POLLIT only)
